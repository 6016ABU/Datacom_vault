...
![900](assets/6、MPLS-VPN（hub-spoke模型）/file-20260519155356066.png)
**R2：**
```D
#  
...
![700](assets/6、MPLS-VPN（hub-spoke模型）/file-20260519155356060.png)

2.在AR4上查看vpn-instance B 的路由表：得知：100.7.7.7 是IBGP路由学来的，存在标记Flags RD 需要递归查询？
![700](assets/6、MPLS-VPN（hub-spoke模型）/file-20260519155356052.png)

3.查看FIB表 查看下一跳2.2.2.2 如何走：得知：走2.2.2.2 需要进行标签的封装
![700](assets/6、MPLS-VPN（hub-spoke模型）/file-20260519155356046.png)
 
4.查看VPNv4 路由表查看封装私有标签情况：得知：需要封装私网标签：1029
![700](assets/6、MPLS-VPN（hub-spoke模型）/file-20260519155356039.png)
5.查看公网标签如何封装：得知：需要封装公网标签：1024
![700](assets/6、MPLS-VPN（hub-spoke模型）/file-20260519155356031.png)

6.在AR3上查看，到AR2的标签封装：得知是：3号标签，pop栈，剩下私网标签
![](assets/6、MPLS-VPN（hub-spoke模型）/file-20260519155356024.png)

7.在AR2上查看标签分配情况：
![700](assets/6、MPLS-VPN（hub-spoke模型）/file-20260519155356017.png)
...
![700](assets/6、MPLS-VPN（hub-spoke模型）/file-20260519155356009.png)  
![700](assets/6、MPLS-VPN（hub-spoke模型）/file-20260519155356002.png)     
![](assets/6、MPLS-VPN（hub-spoke模型）/file-20260519155355975.png)
![](assets/6、MPLS-VPN（hub-spoke模型）/file-20260519155355983.png)