...
Border：VXLAN网络和==外部网络通信的节点==，用于外部流量进入VXLAN网络或VXLAN内部流量访问外部，  
一般连接具有三层转发能力的设备（如Router、Firewall）。
![](assets/2、基本概念/file-20251212164626574.png)  

**VXLAN二层网关、三层网关**
![](assets/2、基本概念/file-20251212164626574%201.png)  
...
![](assets/2、基本概念/file-20251212164626573.png)  

**分布式与集中式网关**
![](assets/2、基本概念/file-20251212164626570.png)
