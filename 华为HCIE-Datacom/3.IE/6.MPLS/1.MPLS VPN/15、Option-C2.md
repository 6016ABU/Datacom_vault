...
## 拓扑
![](assets/15、Option-C2/file-20260519155416150.png)
...
![](assets/15、Option-C2/file-20260519155416185.png)  
![](assets/15、Option-C2/file-20260519155416178.png)
### 数据平面：
1.PE1查表：
[PE1]display bgp vpnv4 all routing-table 192.168.2.0，发现去往192.168.2.0/24需要进行私网标签1027封装，下一跳是7.7.7.7需要递归到IGP
![](assets/15、Option-C2/file-20260519155416199.png)  
![](assets/15、Option-C2/file-20260519155416206.png)  

2.去往7.7.7.7的TunnelID非0，需要mpls‘封装 1025标签
[PE1]display fib 7.7.7.7

![](assets/15、Option-C2/file-20260519155416192.png)  
![](assets/15、Option-C2/file-20260519155416221.png)  
![](assets/15、Option-C2/file-20260519155416213.png)  

3.通过中间结点：公网标签替换为1027，与私网标签一致
[P1]dis mpls lsp

![](assets/15、Option-C2/file-20260519155416234.png)

公网标签
![](assets/15、Option-C2/file-20260519155416228.png)  

4.数据到达ASBR1后，因为存在route-policy，会更新mpls标签，该标签会一直沿用到倒数第二跳弹出
![](assets/15、Option-C2/file-20260519155416240.png)  

6.数据包到达PE2，后公网标签弹出，PE2更具私网标签，将数包送到对应的接口
![](assets/15、Option-C2/file-20260519155416248.png)
