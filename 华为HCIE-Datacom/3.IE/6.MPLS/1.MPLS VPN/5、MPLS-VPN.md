...
![](assets/5、MPLS-VPN/file-20260519155355151.png)

```
dis bgp vpnv4 all peer # 查看VPNv4邻居信息  
dis bgp vpnv4 all routing-table # 查看VPNv4路由信息
```
 ![1000](assets/5、MPLS-VPN/file-20260519155355145.png)  
![](assets/5、MPLS-VPN/file-20260519155355138.png)
### MPLS VPN配置思路：  
1.公网IGP与LDP邻居建立  
2.站点VPN参数规划  
绑定VPN实例信息  
...
bgp 100  
 ...
 ipv4-family vpn-instance C   
  import-route ospf 2
```
![600](assets/5、MPLS-VPN/file-20260519155355130.png)
![600](assets/5、MPLS-VPN/file-20260519155355123.png)
![600](assets/5、MPLS-VPN/file-20260519155355115.png)
### **两张表项存在相互转换的能力：**  
...
![](assets/5、MPLS-VPN/file-20260519155355104.png)