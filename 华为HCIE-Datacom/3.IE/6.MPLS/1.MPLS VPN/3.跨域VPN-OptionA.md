# Option A
1.AS内部再IGP上建立BGP,VPNv4邻居。
2.ASBR之间可以
	1. 配置直连，通过建立实例vpn-instance 建立邻居。
	2. 配置IGP（ospf），再在实例中引入IGP（但是得注意DNbit置位1的情况。）
...
**发送端：**
![](assets/3.跨域VPN-OptionA/file-20260519155844930%201.png)

**接收端**
![](assets/3.跨域VPN-OptionA/file-20260519155844930.png)
...
![](assets/3.跨域VPN-OptionA/file-20260519155844928.png)
