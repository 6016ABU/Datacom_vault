...
## 1.站点和Hub都是BGP
![](assets/7.1、Hub&Spoke模型路由发布的三种方式/file-20260507153812189.png)  
## 2.站点和Hub都是OSPF
![](assets/7.1、Hub&Spoke模型路由发布的三种方式/file-20260507153812184.png)
注：与BGP不通，OSPF 100 与OSPF 200的执行动作不同，
...
## 3.站点OSPF，Hub-BGP
![](assets/7.1、Hub&Spoke模型路由发布的三种方式/file-20260507153812170.png)

## 存在问题的第四种方式：
==IGP再引入BGP路由时，会忽略AS_Path。==
![](assets/7.1、Hub&Spoke模型路由发布的三种方式/file-20260507153812171.png)
